	...
	<div class="wrapper">
		...
		<div class="container-fluid height-1000 content">
			...
			<script type="text/javascript"
				src="<%=baseURL%>assets/plugins/jquery/jquery.min.js?a=1"></script>
			<script type="text/javascript"
				src="<%=baseURL%>assets/plugins/jquery/jquery-migrate.min.js?a=1"></script>
			<script type="text/javascript"
				src="<%=baseURL%>assets/plugins/bootstrap/js/bootstrap.min.js?a=1"></script>
			<!-- JS Implementing Plugins -->
			<script type="text/javascript"
				src="<%=baseURL%>assets/plugins/back-to-top.js?a=1"></script>
			<script type="text/javascript"
				src="<%=baseURL%>assets/plugins/smoothScroll.js?a=1"></script>
			<!-- JS Customization -->
			<script
				src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.12/jquery-ui.min.js?a=1"
				type="text/javascript" charset="utf-8"></script>
			<script
				src="http://rvera.github.io/image-picker/image-picker/image-picker.js?a=1"
...
<link rel="stylesheet"
	href="<%=baseURL%>assets/plugins/jstree/themes/default/style.min.css">
			...
			<script src="<%=baseURL%>assets/plugins/tagz/bootstrap-tagsinput.js?a=1"
				type="text/javascript" charset="utf-8"></script>
			<script type="text/javascript"
				src="//cdn.tinymce.com/4/tinymce.min.js?a=1"></script>
			<script type="text/javascript"
				src="<%=baseURL%>assets/plugins/fancybox/source/jquery.fancybox.pack.js?a=1"></script>

			<script type="text/javascript"
				src="<%=baseURL%>assets/js/plugins/fancy-box.js?a=1"></script>
	<script type="text/javascript"
		src="<%=baseURL%>assets/plugins/jstree/jstree.js?a=1"></script>
			<!-- JS Page Level -->
